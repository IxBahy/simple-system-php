...
if (isset($_POST["login"])) {
    $name = $_POST["userName"];
    $passwd = $_POST["passwd"];
    $select = "SELECT * FROM `admins` WHERE `name`='$name' AND `passwd`='$passwd'";
    ...
    if ($count == 1) {
        ...
        header("location: /backend-training/5th-task/welcome.php ");
    } else {
    ...
    <div class="card text-bg-secondary  mx-auto my-auto  " style="width:400px; height:300px;">
        <form method="POST">
            ...
            <div class="mb-3 mt-4 px-4 ">
                <input type="password" class="  form-control " name="passwd" placeholder="Password" id=" exampleInputPassword1">
            </div><!-- input  passwd-->
